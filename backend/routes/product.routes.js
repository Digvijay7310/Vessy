...
import { createProduct, deleteProduct, getProductById, getProducts, getProductsByCategoryName, getWishList, searchProducts, searchSuggestions, updateProduct, wishlistToggle } from "../controllers/product.controller.js"
import { upload } from "../middlewares/multer.middleware.js"

const router = express.Router()

router.get('/', searchProducts)
router.get('/search-suggestion', searchSuggestions);

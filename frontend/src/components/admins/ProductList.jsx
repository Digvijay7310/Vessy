...
export default function ProductList({ refresh }) {
  ...
  return (
    <div className="bg-white p-4 mt-4 overflow-y-scroll w-xs rounded shadow">
      <h2 className="font-bold mb-2">Products</h2>

      {products.map(p => (
        <div key={p._id} className="flex flex-col border-b py-2 hover:bg-yellow-100 transition-all duration-150">
